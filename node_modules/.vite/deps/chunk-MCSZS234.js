import {
  EditorView
} from "./chunk-LTOTGIEL.js";
import {
  InputRule,
  undoInputRule
} from "./chunk-E6J3GLAD.js";
import {
  AllSelection,
  DOMParser,
  EditorState,
...
function nodeRule(regexp, nodeType, options = {}) {
  return new InputRule(regexp, (state, match, start, end) => {
    ...
    const node2 = nodeType.createAndFill(attrs);
    if (node2) {
      tr.replaceRangeWith(nodeType.isBlock ? tr.doc.resolve(start).before() : start, end, node2);
...
function markApplies(doc2, ranges, type, enterAtoms) {
  for (let i3 = 0; i3 < ranges.length; i3++) {
    ...
    doc2.nodesBetween($from.pos, $to.pos, (node2, pos) => {
...
for (i3 = 0; i3 < 10; i3++) base[48 + i3] = base[96 + i3] = String(i3);
var i3;
for (i3 = 1; i3 <= 24; i3++) base[i3 + 111] = "F" + i3;
var i3;
for (i3 = 65; i3 <= 90; i3++) {
...
var Ke = (e2) => (e2.inject(se, "").inject(V3, {}).inject(ie3, (t2) => t2).inject(ne, [$3, H3, Y]).record(J2), async () => {
  ...
  const t2 = e2.get(b3), r = e2.get(q4), i3 = e2.get(ue), n3 = e2.get(ie3), a2 = e2.get(N3), h2 = e2.get(se), m2 = ct(h2, r, t2), f3 = [
    ...a2,
    new Plugin({
      key: mt,
      state: {
...
//# sourceMappingURL=chunk-MCSZS234.js.map
